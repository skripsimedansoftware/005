...
<section class="content-header">
	<h1>Administrator<small>Nama Pembimbing</small></h1>
</section>
			...
			<table class="table table-responsive table-bordered table-condensed datatables">
				...
				<tbody>
					...
					<tr>
						...
						<td rowspan="2" class="text-center" style="padding-top: 3%;"><?php echo ($mahasiswa->num_rows() >= 1)?'<a href="mahasiswa/detail/'.$mahasiswa->row()->id.'">'.$mahasiswa->row()->nama_lengkap.'</a>':'Mahasiswa tidak ditemukan' ?></td>
						...
						<td>
							...
							if ($doping->num_rows() >= 1) {
								echo '<a href="dosen/detail/'.$doping->row()->id.'">'.$doping->row()->nama_lengkap.'</a>';
					...
					<tr>
						...
						<td>
							...
							if ($doping->num_rows() >= 1) {
								echo '1.) <a href="dosen/detail/'.$doping->row()->id.'">'.$doping->row()->nama_lengkap.'</a>&nbsp;&nbsp;&nbsp;&nbsp;';
							} else {
							...
							if ($doping->num_rows() >= 1) {
								echo '2.) <a href="dosen/detail/'.$doping->row()->id.'">'.$doping->row()->nama_lengkap.'</a>&nbsp;&nbsp;&nbsp;&nbsp;';
							} else {
