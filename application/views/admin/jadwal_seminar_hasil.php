				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo base_url($this->router->fetch_class().'/generate_pdf_2/'.$jadwal['mahasiswa'].'/penyerahan-berkas-seminar') ?>" class="btn btn-xs bg-red"><i class="fa fa-print"></i> penyerahan berkas</a>
