...
<section class="content-header">
	<h1>Administrator<small>Dosen</small></h1>
</section>
...
<section class="content">
	<div class="box box-info">
		...
		<div class="box-body">
			<form method="POST" action="<?php echo base_url($this->router->fetch_class().'/tambah_dosen') ?>">
				<div class="col-lg-6">
					<div class="form-group">
						<label>NIK</label>
						<input class="form-control" type="text" name="nik" placeholder="NIK" value="<?php echo set_value('nik') ?>">
