...
<section class="content-header">
	<h1>Dosen<small>Konsultasi Mahasiswa</small></h1>
</section>
...
<section class="content">
	<div class="box box-info">
		...
		<div class="box-footer">
			<div class="row">
				<form method="post" action="<?php echo base_url($this->router->fetch_class().'/konsultasi/'.$this->uri->segment(3)) ?>" enctype="multipart/form-data">
					<div class="col-lg-3">
